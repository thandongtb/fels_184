...
@section('title')
    {{ trans('admin/users.user_follower_title') }}
@endsection
...
@section('content')
 <div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header text-center">{{ trans('admin/users.user_follower_title') }}</h1>
        </div>
    </div>
                ...
                <div class="panel-body">
                    <table class="table table-user-information">
                        <tbody>
                            ...
                            <tr>
                                <td><strong>{{ trans('admin/users.follower') }}:</strong></td>
                                <td></td>
                            </tr>
                        </tbody>
                    </table>
